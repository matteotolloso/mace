...
python utils/plt_epoch_au_eu.py \
  --inputs experiment_C/results/mace_run-0_epoch_outputs.txt experiment_C/results/mace_run-1_epoch_outputs.txt experiment_C/results/mace_run-2_epoch_outputs.txt experiment_C/results/mace_run-3_epoch_outputs.txt experiment_C/results/mace_run-4_epoch_outputs.txt \
  --split valid \
  --clip_percentile 100 \
  --drop_first_k_epochs 0 \
  --output_csv experiment_C/results/unc_vs_epoch_valid-mv-sp.csv \
  --output_plot experiment_C/results/unc_vs_epoch_valid-mv-sp.png \
  --plot_log_variance