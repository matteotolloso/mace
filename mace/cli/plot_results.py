...
# TOTAL uncertainty (variance key written by your eval script)
# metrics_total = uq_parity_from_paths(
#     val_path="/raid/m.tolloso/mace/outputs/eval/mace-mv-val.xyz",
#     test_path="/raid/m.tolloso/mace/outputs/eval/mace-mv-test.xyz",
#     ref_energy_key="wb97x_dz.energy",
#     pred_energy_key="MACE_energy",
#     pred_var_key="MACE_energy_var",
#     per_atom=True,
#     n_bins=15,
#     min_count=20,
#     title="TOTAL uncertainty (ale+epi) parity on TEST",
# )

# ALEATORIC only
# metrics_ale = uq_parity_from_paths(
#     val_path="...val.xyz",
#     test_path="...test.xyz",
#     ref_energy_key="wb97x_dz.energy",
#     pred_energy_key="MACE_energy",
#     pred_var_key="MACE_energy_aleatoric_var",
#     per_atom=True,
#     title="ALEATORIC uncertainty parity on TEST",
# )

# EPISTEMIC only
# metrics_epi = uq_parity_from_paths(
#     val_path="...val.xyz",
#     test_path="...test.xyz",
#     ref_energy_key="wb97x_dz.energy",
#     pred_energy_key="MACE_energy",
#     pred_var_key="MACE_energy_epistemic_var",
#     per_atom=True,
#     title="EPISTEMIC uncertainty parity on TEST",
# )