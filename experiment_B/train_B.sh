...
CUDA_VISIBLE_DEVICES=7 python mace/cli/run_train.py --config experiment_B/config_B.yml --foundation_model experiment_A/checkpoints/mace_run-5.model --seed 5 --wandb_name mace_seed_5 &
PID1=$!
sleep 180

CUDA_VISIBLE_DEVICES=7 python mace/cli/run_train.py --config experiment_B/config_B.yml --foundation_model experiment_A/checkpoints/mace_run-6.model --seed 6 --wandb_name mace_seed_6 &
PID2=$!
sleep 180

CUDA_VISIBLE_DEVICES=6 python mace/cli/run_train.py --config experiment_B/config_B.yml --foundation_model experiment_A/checkpoints/mace_run-7.model --seed 7 --wandb_name mace_seed_7 &
PID3=$!
sleep 180   

CUDA_VISIBLE_DEVICES=6  python mace/cli/run_train.py --config experiment_B/config_B.yml --foundation_model experiment_A/checkpoints/mace_run-8.model --seed 8 --wandb_name mace_seed_8 &
PID4=$!
sleep 180

CUDA_VISIBLE_DEVICES=5 python mace/cli/run_train.py --config experiment_B/config_B.yml --foundation_model experiment_A/checkpoints/mace_run-9.model --seed 9 --wandb_name mace_seed_9 &
PID5=$!
