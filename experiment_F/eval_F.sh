...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/train_curves.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/train_curves.svg
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/reliability.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/reliability_id_cal.svg \
  --log-level INFO \
  --log-every-batches 1 \
  --device cuda \
  --batch-size 256
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/reliability.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/reliability_id_nocal.svg \
  --log-level INFO \
  --log-every-batches 1 \
  --device cuda \
  --batch-size 256
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/reliability.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/reliability_ood_cal.svg \
  --log-level INFO \
  --log-every-batches 1 \
  --device cuda \
  --batch-size 256
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/reliability.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/reliability_ood_nocal.svg \
  --log-level INFO \
  --log-every-batches 1 \
  --device cuda \
  --batch-size 256
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/epoch_raw.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/epoch_raw_train.svg
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/epoch_quality.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/epoch_quality_id.svg
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/epoch_quality.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/epoch_quality_ood.svg
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/epoch_quality.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/epoch_quality_train.svg
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/distribution.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/distribution_id.svg
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/distribution.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/distribution_ood.svg
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/distribution.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/distribution_train.svg
...
CUDA_VISIBLE_DEVICES=${GPU_ID} python eval/energy_ood.py \
  ...
  --output-plot experiment_F/evaluation/cache/split_${split_seed}/energy_ood.svg
}
